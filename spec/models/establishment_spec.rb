  ...
  describe '#valid?' do
    context 'Campo Vazio:' do
      ...
      it 'Endereço é obrigatório' do
        ...
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: '', phone_number: '11981546985', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Telefone é obrigatório' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Email é obrigatório' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '11981546985', email: '', user_id: user.id)
    ...
    context 'Validação de Dados:' do
      it 'Telefone não pode ter o tamanho menor que 10' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '119815485', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Telefone não pode ter o tamanho maior que 11' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136', 
                              full_address: 'Av Presidente Medice', phone_number: '1198154858754', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Telefone não pode ter letras' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '119815485as', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Telefone não pode ter simbolos' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '(11) 98154-8548', email: 'contato@ifood.com', user_id: user.id)
      ...
      it 'Email tem que ser válido' do
        user = User.create!(name: 'Andre', last_name: 'Silva Lopes', cpf: '44749124621', email: 'andre@email.com', password: 'password5498')
        e = Establishment.new(corporate_name: 'Ifood Distribuidora Alimentícia', brand_name: 'Ifood', restration_number: '39823425000136',
                              full_address: 'Av Presidente Medice', phone_number: '11981546985', email: 'contato@ifood',user_id: user.id)
